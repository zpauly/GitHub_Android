...
public class PushEventsBean extends EventsBean.PayloadBean {
    /**
     ...
     * author : {"name":"baxterthehacker","email":"baxterthehacker@users.noreply.github.com","username":"baxterthehacker"}
     * committer : {"name":"baxterthehacker","email":"baxterthehacker@users.noreply.github.com","username":"baxterthehacker"}
     * added : []
     * removed : []
     * modified : ["README.md"]
     */
     ...
     * owner : {"name":"baxterthehacker","email":"baxterthehacker@users.noreply.github.com"}
     * private : false
    ...
    public void setPusher(PusherBean pusher) {
        this.pusher = pusher;
    }
