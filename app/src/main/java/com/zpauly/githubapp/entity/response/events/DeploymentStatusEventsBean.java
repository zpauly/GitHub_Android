...
public class DeploymentStatusEventsBean extends EventsBean.PayloadBean {
    /**
    ...
    private DeploymentStatusBean deployment_status;
    /**
    ...
    public DeploymentStatusBean getDeployment_status() {
        return deployment_status;
    }

    public void setDeployment_status(DeploymentStatusBean deployment_status) {
