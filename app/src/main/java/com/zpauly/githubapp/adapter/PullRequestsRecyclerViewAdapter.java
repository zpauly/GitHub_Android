...
public class PullRequestsRecyclerViewAdapter extends LoadMoreRecyclerViewAdapter<Payload.PullRequestBean, IssueViewHolder> {
    ...
    public void bindContentViewHolder(IssueViewHolder holder, int position) {
        final Payload.PullRequestBean data = getData().get(position);
